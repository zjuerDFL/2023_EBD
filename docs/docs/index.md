...
每个个人实验均占总成绩的 **4%** ，其中验收分数和实验报告分数各占一半，共计 **28%** 。

个人实验实验报告请务必于 **实验报告截止之前** 提交至学在浙大平台。若实验报告未按时提交，可在实验报告截止后的两周内联系助教进行补交，补交后的实验报告分数将不超过满分的 **90%** （一周内补交）或 **50%** （两周内补交）。两周后不再接受实验报告的补交。

### 组队大程

大程分数占总成绩的 **32%**，其中有四次阶段性提交，每次占总成绩的 **7%** ，共计 **28%** 的基本分。剩余的 **4%** 为加分项。
